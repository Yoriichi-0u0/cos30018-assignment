...
public class MainDashboardFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btnSpawnScenario = new Button("3. Auto Demo (1B, 3D, 5B)");
        ...
        logList.setCellFactory(lv -> new ListCell<String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    setText(null);
                    setGraphic(null);
                    setStyle("-fx-background-color: #1e1e22;");
                    return;
                }
                ...
                if (item.contains("[SYSTEM]")) {
                    setStyle("-fx-text-fill: #96fa96; -fx-background-color: #1e1e22; -fx-font-family: 'Consolas'; -fx-font-size: 12px;");
                } else if (item.contains("[BROKER]")) {
                    setStyle("-fx-text-fill: #fbc02d; -fx-background-color: #1e1e22; -fx-font-family: 'Consolas'; -fx-font-size: 12px;");
                } else if (item.contains("[AutoBuyer_") || item.contains("[ManualBuyer_")) {
                    setStyle("-fx-text-fill: #ff6b81; -fx-background-color: #1e1e22; -fx-font-family: 'Consolas'; -fx-font-size: 12px;");
                } else if (item.contains("[Dealer_")) {
                    setStyle("-fx-text-fill: #4daafc; -fx-background-color: #1e1e22; -fx-font-family: 'Consolas'; -fx-font-size: 12px;");
                } else {
                    setStyle("-fx-text-fill: #a0a0ab; -fx-background-color: #1e1e22; -fx-font-family: 'Consolas'; -fx-font-size: 12px;");
                }
            }
        });
        ...
        btnReport.setOnAction(e -> {
            if (agents.BrokerAgent.instance != null) {
                ...
                alert.getDialogPane().lookup(".header-panel")
                        .setStyle("-fx-background-color: #1565c0;");
